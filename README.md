...
Data cleaning: Remove unnecessary columns such as "Unnamed: 32" and "id."
Data Splitting: Separating the data set into a training and testing set to verify the efficiency of the model.
